 ...
 *
 * mostrar_en_ui: si es false, el tipo sigue en la API pero no aparece en /catalogos.
 *
 * dependencias: tablas/columnas para contar usos (mensajes). No se usan para borrar.
 * match=nombre compara LOWER(TRIM(columna)) con el nombre del registro (proyectos VARCHAR).
 */
return [
    'procesos' => [
        'tabla' => 'procesos',
    ...
    'proyectos' => [
        ...
        'dependencias' => [
            ['tabla' => 'matriz_aplicabilidad', 'columna' => 'proyecto', 'etiqueta' => 'filas de matriz', 'match' => 'nombre'],
            ['tabla' => 'asignaciones_capacitacion', 'columna' => 'proyecto', 'etiqueta' => 'asignaciones', 'match' => 'nombre'],
            ['tabla' => 'plan_anual_detalle', 'columna' => 'proyecto', 'etiqueta' => 'detalle de plan anual', 'match' => 'nombre'],
        ],
        'mensaje_dependencias' => 'No es posible eliminar este proyecto porque tiene información histórica relacionada. Puede inactivarlo para evitar su uso en nuevos registros.',
    ],
    ...
    'tipos-capacitacion' => [
        ...
        'etiqueta' => 'Tipos de capacitación',
        'mostrar_en_ui' => true,
        'soft_delete' => true,
        'campos' => [
